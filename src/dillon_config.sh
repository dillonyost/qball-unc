...
export LIBS_BLAS="-L$LIBHOME/BLAS/lib/ -lesslsmpbg"
...
export CFLAGS="-qhot=novector -qsimd=auto -g -O3 -DUSE_MPI -DSCALAPACK -D$PLT $INCLUDE $DFLAGS"
export  CXXFLAGS=" -g -O3 -qarch=qp -qsmp=omp -qtune=qp -DUSE_MPI -DSCALAPACK -D$PLT $INCLUDE $DFLAGS"

./configure --with-essl-prefix=/soft/libraries/essl/current/ --with-xerces-prefix=/home/dyost/Dsource/Dlib/xerces-c-3.1.1/Dbuild/ --with-lapack=/soft/libraries/alcf/current/xl/LAPACK/lib/liblapack.a --with-scalapack=/soft/libraries/alcf/current/xl/SCALAPACK/lib/libscalapack.a --prefix=/home/dyost/qball/qball_etrs/
