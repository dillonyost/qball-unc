...
//
////////////////////////////////////////////////////////////////////////////////
// $Id: TDMLWFTransform.C,v 1.6 2017-04-30 11:47:10 dyost Exp $
...
double TDMLWFTransform::spread2(int i, int j)
{
  ...
  return fac*fac * ( 1.0 - real(conj(c)*c) - real(conj(s)*s) ); //DCY real component or should it be square modulus?
}
