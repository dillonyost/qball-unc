...
#include "ElectricEnthalpy.h" //DCY
#include "Timer.h"
using namespace std;
...
class EnergyFunctional
{
  ...
  double ekin_, econf_, eps_, enl_, ehub_, ehart_, 
      ecoul_, exc_, esr_, eself_, ets_, epv_, eexf_, etotal_, eefield_, enthalpy_; //DCY
  ...
  double enthalpy(void) const { return enthalpy_; } //DCY
  double eefield(void) const { return eefield_; } //DCY
